...
def mid_size_tech_company(employee_count: int = 500) -> OrgProfile:
    ...
    return OrgProfile(
        ...
        location_count=max(1, min(100, employee_count // 400 + 1)),
        system_count_range=s(c.systems, 20, 3500),
        network_specs=[
        ...
        vendor_count_range=s(c.vendors, 5, 2000),
        data_asset_count_range=s(c.data_assets, 10, 3000),
        policy_count_range=s(c.policies, 5, 400),
        ...
        control_count_range=s(c.controls, 5, 800),
        risk_count_range=s(c.risks, 3, 400),
        threat_count_range=s(c.threats, 2, 80),
        integration_count_range=s(c.integrations, 3, 1000),
        data_domain_count_range=s(c.data_domains, 3, 40),
        data_flow_count_range=s(c.data_flows, 4, 1500),
        org_unit_count_range=s(c.org_units, 3, 200),
        ...
        product_count_range=s(c.products, 3, 150),
